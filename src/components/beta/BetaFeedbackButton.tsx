  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-36 left-4 w-12 h-12 bg-purple-600 hover:bg-purple-700 rounded-full shadow-lg flex items-center justify-center text-white transition-colors z-40"
